...
The original :doc:`simple autoencoder<../../simple_autoencoder/autoencoder>` was trained for 100 epochs on 2566 MSLP fields. What happens if we reduce the number of training fields (to 100).

.. literalinclude:: ../../../experiments/simple_autoencoder_perturbations/less_training_data/autoencoder.py

Less training data should produce a poorer quality reconstruction, and it does. It should also run through the training much faster, and it does that too. (:doc:`See original <../../simple_autoencoder/summary>`):

.. figure:: ../../../experiments/simple_autoencoder_perturbations/less_training_data/validation/comparison_full.png
   :width: 95%
   :align: center
   :figwidth: 95%
...
.. literalinclude:: ../../../experiments/simple_autoencoder_perturbations/less_training_data/validation/compare_full.py
