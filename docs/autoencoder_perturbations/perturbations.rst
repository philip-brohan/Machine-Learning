...
.. toctree::
   ...
   With elu activations <activations/elu/autoencoder>
   With relu activations <activations/relu/autoencoder>
   With sigmoid activations <activations/sigmoid/autoencoder>
   With softmax activations <activations/softmax/autoencoder>
   With softplus activations <activations/softplus/autoencoder>
   With leaky relu activations <activations/leaky_relu/autoencoder>
