...
def axes_geom(layer=0,channel=0,nchannels=2):
     if layer==0: 
...
def plot_weights(weights,layer=0,channel=0,nchannels=2,
                 vmin=None,vmax=None):
...
for layer in [0,2]:
    ...
    for channel in order:
        ...
        plot_weights(w_in,layer=layer,channel=count,nchannels=9,
                     vmin=vmin,vmax=vmax)
        count += 1
