...
# This version uses only 2 neurons in the hidden layer
#   (instead of 32).
...
# Encoding layer 2-neuron fully-connected
encoded = tf.keras.layers.Dense(2, activation='sigmoid')(original)
