...
# This version adds regularisation to help against overfitting.
...
# Encoding layer 32-neuron fully-connected - with regularizer.
encoded = tf.keras.layers.Dense(32, activation='sigmoid',
