...
# Compare a 20CRv2c log-prate field with the same field passed through
#   the autoencoder.
...
parser.add_argument("--variable", help="20CR variable",
                    default='prate',type=str,required=False)
...
# We're not going to do unnormalisation - plot the transformed variable
