...
# Calculate the fields from running this model on each of the test datasets
#  and, for each, the difference between these output fields and the target
#  field. This provides a sample of the expected errors, from the target, if
#  we didn't have the observations.
