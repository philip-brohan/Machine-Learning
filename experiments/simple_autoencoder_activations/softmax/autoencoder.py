...
# This version uses softmax activations
...
encoded = tf.keras.layers.Dense(32, activation='softmax')(original)
# Output layer - same shape as input
decoded = tf.keras.layers.Dense(91*180, activation='softmax')(encoded)
