...
# This version uses softplus activations
...
encoded = tf.keras.layers.Dense(32, activation='softplus')(original)
# Output layer - same shape as input
decoded = tf.keras.layers.Dense(91*180, activation='softplus')(encoded)
