...
# Continue on from a previously trained version
...
discriminator = tf.keras.models.load_model("%s/discriminator" % model_save_dir)
...
generator = tf.keras.models.load_model("%s/generator" % model_save_dir)
...
for epoch in range(n_epochs):
    ...
    save_models(epoch+start_epoch+1)
