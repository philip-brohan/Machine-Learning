...
order=numpy.argsort(numpy.abs(autoencoder.get_weights()[5]))[::-1]
...
plot_hidden(autoencoder.get_weights()[5])
for layer in [0,10]:
    ...
    for channel in range(128):
        ...
        plot_weights(w_in,layer=layer,channel=count,nchannels=144,
                     vmin=vmin,vmax=vmax)
        count += 1
...
fig.savefig("comparison_full_old.png")
