...
def dataset(purpose='training',source='20CR2c',variable='prmsl',length=None,
    ...
    """Provide a tf.data Dataset of analysis data, fot tf.keras model training or tests.

    Data must be available in directory $SCRATCH/Machine-Learning-experiments, previously generated by :func:`create_dataset`.

    Args:
        purpose (:obj:`str`): 'training' (default) or 'test'.
        source (:obj:`str`): Where to get the data from - any string, but needs top be supported by :func:`create_dataset`.
        ...
        shuffle (:obj:`bool`): If True (default), shuffle the data order. I False, present the data in the order ofg he files on disc.
