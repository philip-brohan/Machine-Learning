...
This model is clearly improved by using linear activations - it trains faster and is more accurate (compare :doc:`original <../../../simple_autoencoder/summary>`). It's unlikely, however that this advantage would carry-over to more complex models with more layers.:

.. figure:: ../../../../experiments/simple_autoencoder_activations/linear/validation/comparison_full.png
   :width: 95%
   :align: center
   :figwidth: 95%
...
.. literalinclude:: ../../../../experiments/simple_autoencoder_activations/linear/validation/compare_full.py
